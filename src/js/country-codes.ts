// based on https://github.com/lukes/ISO-3166-Countries-with-Regional-Codes/blob/master/all/all.json
...
export default [
  ...
  { name: 'Macedonia (the former Yugoslav Republic of)', 'alpha-2': 'MK' },
